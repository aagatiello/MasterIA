(define (problem rutas)
    ...
    (:init
        ...
        (conectada puerto almacen)
        (conectada puerto fabrica2)
        (conectada fabrica2 puerto)
        (conectada fabrica2 fabrica1)
        (conectada fabrica1 fabrica2)
        (conectada fabrica1 almacen)
        (conectada almacen fabrica1)
        (conectada almacen fabrica2)
        (conectada fabrica2 almacen)
